...
class DisseminationEventListener(EventListener):
    def __init__(self,
                 engine: Engine,
        ...
        super(DisseminationEventListener, self).__init__(engine, request, triggers, listener_schema, from_date, to_date)

    def __str__(self):
        return f"Dissemination listener to keys: {self.keys}"
    ...
    def callback(self, key: str, value: str):
        ...
        if self._is_expected(not_request):
            ...
            notification: Dict[str, any] = {"event": "dissemination", "request": not_request, "location": value}
